#!/bin/bash
echo -e "\e[31;43m***** Making directory for storing images *****\e[0m"
sudo mkdir /home/pi/motion
sudo chmod a+x /home/pi/motion
echo -e "\e[31;43m***** Installing Python PIP *****\e[0m"
sudo apt-get install python-pip -y
echo -e "\e[31;43m***** Installing GiT *****\e[0m"
sudo apt-get install git -y
echo -e "\e[31;43m***** Installing Python MQTT *****\e[0m"
sudo git clone https://github.com/eclipse/paho.mqtt.python
cd paho.mqtt.python
sudo python setup.py install
cd
echo -e "\e[31;43m***** Installing Screen *****\e[0m"
sudo apt-get install screen -y
echo -e "\e[31;43m***** Installing Motion Camera Software *****\e[0m"
sudo apt-get install motion -y
echo -e "\e[31;43m***** Modifying Motion File - /etc/motion/motion.conf *****\e[0m"
...
echo -e "\e[31;43m***** Change Location of Files to USB *****\e[0m"
sudo sed -i -e 's#/var/lib/motion#/home/pi/motion#g' /etc/motion/motion.conf
echo -e "\e[31;43m***** Edit Motion File *****\e[0m"
sudo sed -i -e 's/start_motion_daemon=no/start_motion_daemon=yes/g' /etc/default/motion
echo -e "\e[31;43m***** Restart Motion *****\e[0m"
sudo service motion restart
echo -e "\e[31;43m***** Run Motion *****\e[0m"
sudo motion
echo -e "\e[31;43m***** Downloading Count Pics and Clear Pics Stuff *****\e[0m"
cd /home/pi
...
echo -e "\e[31;43m***** Modifying CRONTAB *****\e[0m"
